...
public:
    ...
    virtual G4bool ProcessHits(
		G4Step* aStep, G4TouchableHistory* roHist);		// Used by Geant4 hit manager
	G4bool ProcessHits_more(const G4Step*,G4VPhysicalVolume*);	// Used by Useraction step action
