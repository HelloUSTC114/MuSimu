...
echo Format: "[GeneratedFile] [srcDir(\`pwd\`)] [grooveWidth(1.2)] [grooveDepth(1.8)] [omegaGrooveGap(1.2/2)] [grooveOffset(3)] [Omega/Round] [EJ/Air] [Single/Double] [optional: triangleBarL(500)] [optional: triangleBarN0(25)] [optional: coatingThickness(0.12)]"
echo Tips:
